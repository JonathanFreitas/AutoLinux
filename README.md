...
<pre class="prettyprint lang-sh"> curl -o ram.sh https://raw.githubusercontent.com/JonathanFreitas/AutoLinux/main/remove_images_dockermount_ram_memory.sh; chmod 777 ram.sh; ./ram.sh </pre>
